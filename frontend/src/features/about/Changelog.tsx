...
const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    date: '2026-04-15',
    changes: [
      'BIM Viewer: linked BOQ panel displays quantity, unit, and total for each connected position. Geometry popover with two-column layout, expandable properties, and smart quantity rounding',
      'DWG Takeoff: polygon selection with area/perimeter measurements, text annotation popup on entity click, entity name filter for layer-level search, mouse wheel zoom fix',
      'Data Explorer: new BIM-style full-viewport layout replaces the previous compact view',
      'Dashboard: DDC branding refresh, subtitle i18n with 21 language support, unified padding across all cards',
      'Assemblies: import/export JSON for sharing assembly libraries, tag support, drag-reorder components, quick cost preview',
      '5D Cost Model: inline-editable budget lines and snapshots for faster what-if analysis',
      'Finance: summary cards with key metrics, direct module navigation links',
      'Tasks: custom categories with Trello-style management, 4-column Kanban board layout',
      'Schedule: user-selectable project start date for Gantt baseline',
      'Chat: AI onboarding guide for first-time users, blue color scheme aligned with brand',
      'Project Intelligence: tag badges on domain cards, compact card layout, project selector redesign with search',
      'Bugfixes: Contacts country_code column type, RFI response field mismatch, 4 modal layout corrections',
      'UI: unified padding across 37+ pages, offline banner restyle with subtle animation',
    ],
  },
  {
    version: '1.6.0',
